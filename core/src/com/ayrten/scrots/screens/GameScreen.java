...
//	protected ArrayList<Image> gray_timer_bg;
	...
	public GameScreen() {
		...
		trd[0] = new TextureRegionDrawable(new TextureRegion(Assets.play_button));
		trd[1] = new TextureRegionDrawable(new TextureRegion(Assets.pause_button));
...
//			Image gray_bg = gray_timer_bg.get(i);
	...
	private void initializePauseMenu() {
		...
		menu_button.setBounds(menu_button.getX(), menu_button.getY(), menu_button.getWidth(),
				menu_button.getHeight());
