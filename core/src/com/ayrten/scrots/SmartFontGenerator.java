...
public class SmartFontGenerator {
	...
	public BitmapFont createFont(FileHandle fontFile, String fontName, int fontSize) {
		...
		Preferences fontPrefs = Gdx.app.getPreferences("com.ayrten.scrots-preferences");
		...
		if (!loaded || forceGeneration) {
			...
			font = generateFontWriteFiles(fontName, fontFile, (int) (fontSize*ratio), pageSize, pageSize);
		}
		return font;
	}
