...
public class DotGenerator 
{
	...
	public PowerDot_Rainbow genPowerDotRainbow() {
		PowerDot_Rainbow rainbowDot = new PowerDot_Rainbow(Assets.rainbow_dot, gm, Assets.reg_pop_1);
		setRandPositions(rainbowDot);
		return rainbowDot;
	}
	
	public PowerDot_Invincible genPowerDotInvincible(){
		PowerDot_Invincible invincibleDot = new PowerDot_Invincible(Assets.invincible_dot, gm, Assets.reg_pop_1);
		setRandPositions(invincibleDot);
		return invincibleDot;
	}
	
	public PowerDot_Magnet genPowerDotMagnet(){
		PowerDot_Magnet magnetDot = new PowerDot_Magnet(Assets.magnet_dot, gm, Assets.reg_pop_1);
