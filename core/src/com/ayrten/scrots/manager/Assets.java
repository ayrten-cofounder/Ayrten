...
public class Assets {
	...
	public static void loadDotTextures() {
		...
		if (prefs.getBoolean("color_blind", false)) {
			...
			penDot_1 = new Texture(Gdx.files.internal("data/dots/red_dot.png"));
		}
		...
		if (prefs.getBoolean("color_blind", false)) {
			...
			regDot_1 = new Texture(Gdx.files.internal("data/dots/green_dot.png"));
		}
		...
		if (prefs.getBoolean("color_blind", false)) {
			...
			regDot_2 = new Texture(Gdx.files.internal("data/dots/baby_blue_dot.png"));
		}
